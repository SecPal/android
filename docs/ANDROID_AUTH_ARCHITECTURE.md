...
24, 29, 35, 36, and 37 emulators. That variant inherits release minification,
...
customer API hostname. API 37 must additionally prove that the platform's
implicit localhost cleartext exception is suppressed for named and numeric
loopback hosts. The release-resource verifier independently rejects a
...
debug trust overrides, cleartext, and certificate pins.
