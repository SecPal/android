...
public class DebugEnterprisePolicyReceiver extends BroadcastReceiver {
    static final String ACTION_SET_POLICY = "app.secpal.app.action.DEBUG_SET_ENTERPRISE_POLICY";
    static final String ACTION_CLEAR_POLICY = "app.secpal.app.action.DEBUG_CLEAR_ENTERPRISE_POLICY";
