...
- extended the local Prettier scripts and Android quality workflow file globs to include `.mjs` helpers so repository formatting checks cover Node maintenance scripts consistently in both local validation and CI
